...
public class CouchbaseContainer<SELF extends CouchbaseContainer<SELF>> extends GenericContainer<SELF> {
    ...
    protected void configure() {
        addFixedExposedPort(9091, 8091);
        addFixedExposedPort(9092, 8092);
        addFixedExposedPort(9093, 8093);
        addFixedExposedPort(9094, 8094);
        addFixedExposedPort(9095, 8095);
        addFixedExposedPort(21207, 11207);
        addFixedExposedPort(21210, 11210);
        addFixedExposedPort(21211, 11211);
        addFixedExposedPort(19091, 18091);
        addFixedExposedPort(19092, 18092);
        addFixedExposedPort(19093, 18093);
